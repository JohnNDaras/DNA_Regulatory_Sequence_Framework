...
if RUN_FINAL_MODEL:
    ...
    from src.experiments.run_final_best_model import run as run_final
    final_out = run_final(config_path=config_path)
    print(final_out["val_metrics"])

if RUN_SOTA_COMPARE:
    print("Running SOTA comparison")
...
shutil.copy2("configs/base_config.yaml", os.path.join(RESULTS_EXPORT_DIR, "config_used.yaml"))

print("Saved to:", RESULTS_EXPORT_DIR)
print("Done")
